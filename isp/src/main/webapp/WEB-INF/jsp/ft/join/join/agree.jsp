...
.btn_join {color:#fff;background:#308cde;}
	...
	<form:form commandName="searchVO" name="defaultFrm" id="defaultFrm" method="post">
		<input type = 'hidden'  id= "agreeCheck" name ="agreeCheck" value="no">
			...
			<div class="content_box">
				<div class="termsArea">
				    ...
				    <ol>
				        ...
				        <li><span class="pos">⑤</span> 한국전력공사에서 보유중인 개인정보파일은 아래의 사이트에서 검색이 가능합니다.</li>
					</ol>
				</div>
			
			<div class="join_btns c">
		        <a href="#" class="btn btn_big btn_join" onclick="agreeBtn();">약관동의</a>
...
function agreeBtn(){
	$("#agreeCheck").val("yes");  // 약관동의 클릭시 yes 
	fncPageBoard('view','joinForm.do');
}
