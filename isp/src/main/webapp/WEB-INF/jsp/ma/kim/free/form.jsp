...
<div class="content_box">
			...
			<table class="tbl_row_type01"> 
				...
				<tbody>
					<tr>
						...
						<td colspan="3">
							<input type="text" name="feTitle" id="feTitle" class="text w100p"   maxlength="50" value="${freeVO.feTitle}" />
						</td>
					</tr>
					<tr>
		...
		<div class="btn_area">
			<a href="javascript:void(0)" class="btn btn_mdl btn_rewrite" onclick="btnSubmit('${freeVO.feSeq}');">${not empty freeVO.feSeq ? '수정' : '등록'}</a>
